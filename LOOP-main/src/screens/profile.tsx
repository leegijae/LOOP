...
const ProfileEditor: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // 여기에 제출 로직 구현
    console.log('프로필 업데이트:', profile);  // 콘솔에 업데이트된 프로필 출력
    setIsSubmitted(true); // 제출 상태를 true로 설정하여 성공 페이지로 전환
  };
  ...
  const styles: StylesDictionary = {
    ...
    backToEditBtn: {
      backgroundColor: hoverBackToEdit ? 'rgba(26, 115, 232, 0.04)' : 'transparent',
      color: '#1a73e8',
      border: '1px solid #1a73e8',
      padding: '10px 24px',
      fontSize: '14px',
      ...
      <div style={styles.container}>
        <div style={styles.contentWrapper}>
          <div style={styles.successContainer}>
            ...
            <h1 style={styles.successTitle}>프로필이 성공적으로 업데이트되었습니다!</h1>
            <p style={styles.successMessage}>프로필 정보가 LOOP 서비스에 반영되었습니다. 아래에서 업데이트된 정보를 확인하세요.</p>
              ...
              <div style={styles.profileDetailHeader}>
                ...
                <div>
                  <h2 style={{margin: '0', fontSize: '20px', fontWeight: 500}}>
                    {profile.name || <span style={styles.noDataText}>이름 미입력</span>}
                  </h2>
                  <p style={{margin: '4px 0 0', fontSize: '14px'}}>
                    {profile.location || <span style={styles.noDataText}>위치 미입력</span>}
                  </p>
                </div>
              </div>
              ...
              <div style={styles.profileDetailContent}>
                <div style={styles.profileDetailItem}>
                  ...
                  <div style={styles.profileDetailValue}>
                    {profile.email || <span style={styles.noDataText}>이메일 미입력</span>}
                  </div>
                </div>
                
                <div style={{...styles.profileDetailItem, borderBottom: 'none', marginBottom: 0, paddingBottom: 0}}>
                  <div style={styles.profileDetailLabel}>소개</div>
                  <div style={styles.profileDetailValue}>
                    {profile.bio || <span style={styles.noDataText}>소개 미입력</span>}
                  </div>
                </div>
              </div>
            </div>
      ...
      <div style={styles.contentWrapper}>
        ...
        <div style={styles.previewCard}>
          ...
          <div style={styles.previewContent}>
            <div style={{...styles.previewSection, display: 'flex', alignItems: 'center', gap: '20px'}}>
              <img 
                src={profile.photoUrl || 'https://via.placeholder.com/150'} 
                alt=""
        ...
        <div style={styles.card}>
          <div style={styles.header}>
            ...
            <p style={styles.headerSubtitle}>LOOP 서비스에서 사용되는 기본 정보를 관리하세요</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.formRow}>
              <label htmlFor="bio" style={styles.label}>소개</label>
              <textarea
                id="bio"
                name="bio"
                value={profile.bio}
            ...
            <div style={styles.formRow}>
              <label htmlFor="location" style={styles.label}>위치</label>
              <input
                type="text"
                id="location"
                name="location"
